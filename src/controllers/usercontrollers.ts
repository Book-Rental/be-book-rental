...
export const addUserAddress = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        if (!userId) {
            failResponse(res, Messages.UserId_Required, StatusCode.Bad_Request);
            return;
        }

        const result = await addUserAddressService(userId, req.body);

        successResponse(res, result, Messages.Address_Added, StatusCode.Created);
    } catch (err: any) {
        failResponse(res, err.message || "Unable to add address.", StatusCode.Bad_Request);
    }
};
...
export const updateUserAddress = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        const result = await updateUserAddressService(userId, addressId, req.body);

        successResponse(res, result, Messages.Address_Updated, StatusCode.OK);
    } catch (err: any) {
        failResponse(res, err.message || "Unable to update address.", StatusCode.Bad_Request);
    }
};
...
export const deleteUserAddress = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        successResponse(res, {}, Messages.Address_Deleted, StatusCode.OK);
    } catch (err: any) {
        failResponse(res, err.message || "Unable to delete address.", StatusCode.Bad_Request);
    }
};
...
export const getUserAddresses = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        successResponse(res, result, Messages.Success, StatusCode.OK);
    } catch (err: any) {
        failResponse(res, err.message || "Unable to fetch addresses.", StatusCode.Bad_Request);
    }
};
...
export const getAddressById = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        if (!addressId) {
            failResponse(res, "Address Id is required.", StatusCode.Bad_Request);
            return;
        }
